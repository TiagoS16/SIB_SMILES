...
dataset_1.to_csv("../dataset/regression/activity_46_regression.csv", index=False)
...
def standardize(dataset, id_field ,mols_field,class_field):
    ...
    return dataset
#%%
dataset = standardize("../dataset/regression/activity_46_regression.csv", "PUBCHEM_CID", "smiles", "Activity at 46.23 uM")
dataset.save_to_csv("../dataset/regression/standardized_regression.csv")
#%% md
## Feature Generation

#%%
loader = CSVLoader("../dataset/regression/standardized_regression.csv",
                   mols_field='mols',
                   labels_fields='y')
...
print(descript_data)
#%%
descript_data.to_csv('../dataset/regression/descriptors_regression.csv', index=False)
#%%
...
#%%
dataset_rdk_fs = SelectPercentile(score_func=f_regression, percentile=10).fit_transform(dataset_rdk.X, dataset_rdk.y)
...
#%%
descript_data.to_csv("../dataset/regression/descriptors_fs.csv", index=False)
...
pd_rdk_fs.to_csv("../dataset/regression/rdk_fs.csv", index=False)
